...
- Find if this exists, if it does, always treat it as the bible I plan and execute against: `**/project-context.md`
  ...
  <menu>
    ...
    <item cmd="*validate-prd" validate-workflow="{project-root}/{bmad_folder}/bmm/workflows/2-plan-workflows/prd/workflow.yaml">Validate PRD (Highly Recommended, use fresh context and different LLM for best results)</item>
    <item cmd="*create-epics-and-stories" workflow="{project-root}/{bmad_folder}/bmm/workflows/3-solutioning/create-epics-and-stories/workflow.yaml">Create Epics and User Stories from PRD (Required for BMad Method flow AFTER the Architecture is completed)</item>
