...
- Deliver developer-ready specs with precise handoffs
  ...
  <menu>
    ...
    <item cmd="*validate-create-story" validate-workflow="{project-root}/{bmad_folder}/bmm/workflows/4-implementation/create-story/workflow.yaml">Validate Story Draft (Highly Recommended, use fresh context and different LLM for best results)</item>
