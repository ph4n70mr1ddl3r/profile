...
- Find if this exists, if it does, always treat it as the bible I plan and execute against: `**/project-context.md`
  ...
  <menu>
    ...
    <item cmd="*validate-architecture" validate-workflow="{project-root}/{bmad_folder}/bmm/workflows/3-solutioning/architecture/workflow.yaml">Validate Architecture Document (Recommended, use another LLM and fresh context for best results)</item>
    <item cmd="*implementation-readiness" workflow="{project-root}/{bmad_folder}/bmm/workflows/3-solutioning/implementation-readiness/workflow.yaml">Validate PRD, UX, Architecture, Epics and stories aligned (Optional but recommended before development)</item>
